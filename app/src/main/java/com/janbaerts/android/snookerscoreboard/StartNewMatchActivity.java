...
//        playerTextViews[0] = findViewById(R.id.firstPlayerTextView);
//        playerTextViews[1] = findViewById(R.id.secondPlayerTextView);
//        numberPicker = findViewById(R.id.maxFrameNumberPicker);
...
//            fragmentTransaction.add(R.id.playerDetailFrameLayout, selectPlayerFragment, SelectPlayerFragment.TAG);
